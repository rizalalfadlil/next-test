...
### <span style="background-color:green; padding:4px;margin:0px 8px">POST</span> `/api/collections/users/auth-with-password`
body : 
|param|type|
|---|---|
|identity|string|
...
Digunakan untuk melakukan log-in

---

### <span style="background-color:green; padding:4px;margin:0px 8px">POST</span> `/api/collections/users/records`
body :
|atribut|tipe|
|---|---|
|*username|string|
|name|string|
|*type|`admin` `manajer` `kasir`|
|*password|string|
|*confirmPassword|string|

Digunakan untuk melakukan register/membuat akun baru

---
### <span style="background-color:blue; padding:4px;margin:0px 8px">GET</span> `/api/collections/users/records`

Untuk mendapatkan list daftar user

---
### <span style="background-color:blue; padding:4px;margin:0px 8px">GET</span> `/api/collections/users/records/:id`
...
---
### <span style="background-color:red; padding:4px;margin:0px 8px">DELETE</span> `/api/collections/users/records/:id`
parameter : 
|parameter|tipe|
|---|---|
|id|string|

Untuk menghapus user dengan id tertentu

---
### <span style="background-color:orange; padding:4px;margin:0px 8px">PATCH</span> `/api/collections/users/records/:id`
parameter : 
|parameter|tipe|
|---|---|
|id|string|
...
Untuk memperbarui data user dengan id tertentu

---
## Activity
### <span style="background-color:blue; padding:4px;margin:0px 8px">GET</span> `/api/collections/activity/records`

Untuk mendapatkan list daftar aktivitas

---
### <span style="background-color:green; padding:4px;margin:0px 8px">POST</span> `/api/collections/activity/records`
body : 
|atribut|tipe|
|---|---|
|log|text|
